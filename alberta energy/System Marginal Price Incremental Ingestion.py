...
# MAGIC %md ### Get AESO Mariginal Price Data
...
resp = aeso_instance.get_system_marginal_price(
...
df.write.mode("overwrite").saveAsTable("gshen_catalog.aeso.marginal_price_snapshot")
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS gshen_catalog.aeso.marginal_price_raw
# MAGIC USING DELTA
# MAGIC AS SELECT *
# MAGIC FROM gshen_catalog.aeso.marginal_price_snapshot
# MAGIC WHERE 1 = 0

# COMMAND ----------

# MAGIC %sql
# MAGIC MERGE INTO gshen_catalog.aeso.marginal_price_raw as target USING gshen_catalog.aeso.marginal_price_snapshot as source ON target.begin_datetime_mpt = source.begin_datetime_mpt
# MAGIC WHEN MATCHED THEN
# MAGIC UPDATE
# MAGIC SET
# MAGIC   target.system_marginal_price = source.system_marginal_price,
